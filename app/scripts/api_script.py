...
import requests
from dot_export import secrets
    ...
    with concurrent.futures.ThreadPoolExecutor() as executor:
        for year in range(2017, 2018):
            ...
            for week in set_range:
                ...
                futures = [executor.submit(data_requests, endpoint, year, week) for endpoint in
                           [projected_player_pts, actual_player_pts, team_performance, odds]]
